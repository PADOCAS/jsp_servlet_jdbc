...
public class FilterAutenticacao implements Filter {
    ...
    private void chargedConnection() {
    ...
    public void init(FilterConfig filterConfig) {
        chargedConnection();
//        connection = SingleConnection.getConnection(); (Erro findBugs)
        ...
        if (connection != null) {
            try {
                ...
                for (File file : files) {
                    ...
                    if (!alterJaRodado) {
                        String sql = getSqlAlterCharged(file);

                        if (sql != null
                                && !sql.isEmpty()) {
                            try ( PreparedStatement psqlExecute = connection.prepareStatement(sql);) {
    ...
    private String getSqlAlterCharged(File file) throws Exception {
        StringBuilder sql = new StringBuilder();

        FileInputStream fileInputStream = new FileInputStream(file);
        //Faz o close no scanner automaticamente com o try:
