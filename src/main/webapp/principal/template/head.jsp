<%-- 
    Document   : head
    Created on : 7 de jun. de 2022, 11:28:48
    Author     : lucia
--%>
...
<head>
    <title>JSP/Servlets/JDBC - jDev Luciano</title>
    ...
    <meta name="description" content="Projeto feito em JSP para treinamento" />
    <meta name="author" content="Luciano Decio Pacheco de Almeida Prado Neto" />
    <!-- Favicon icon -->
